...
const App = React.createClass({
  render: function () {
    ...
    const setSurveyField = (fieldName, value) => store.dispatch(
      {
      ...
      <div className="foo">
        <div className="row">
          <div className='col-md-4'>
            <h2>Survey</h2>
            <Survey surveyFields={surveyFields} survey={survey} setSurveyField={setSurveyField}/>
            <h2>Rules</h2>
            <Rules surveyFields={surveyFields} ruleDict={ruleDict}/>
            <h2>Configuration</h2>
