import { cond, T, assoc, dissoc } from 'ramda'
...
module.exports = cond([
  ...
  [actionEq('SET_SURVEY_FIELD'), (state, action) => ({
    ...state,
    survey: action.value === null
      ? dissoc(action.fieldName, state.survey)
      : assoc(action.fieldName, action.value, state.survey)
  })],
